...
class Copiador {
	...
	public static void main(String[] args) throws IOException {
		/*
		 * Para que funcione correctamente deberá: · tener un archivo fuente.txt en el
		 * directorio archivosES\entrada · tener creado el directorio archivosES\salida
		 */
		...
		// Instancia un FileReader y un FileWriter que se encargaran de leer y escribir
