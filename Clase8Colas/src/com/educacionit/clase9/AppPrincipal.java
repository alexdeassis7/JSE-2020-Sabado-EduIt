...
public class AppPrincipal {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("no podes extraer elemneto de una cola VACIA!");
		...
		// Observamos que elemento esta en el primer puesto de la cola (sin eliminarlo) ,RETORNA NULL si esta vacia 
